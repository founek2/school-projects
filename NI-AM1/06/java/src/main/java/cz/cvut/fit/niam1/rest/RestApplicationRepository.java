...
public class RestApplicationRepository {
    ...
    private static final List<String> nonces = new ArrayList<>();
    ...
    public String newNonce(String prefix) {
        Date d = new Date();
        String nonce = prefix + d.getTime();

        nonces.add(nonce);
        return nonce;
    }

    public boolean validateAndUseNonce(String nonce) {
